export type WsMessageType = 'JOIN' | 'JOIN_ACK' | 'PLAYER_JOINED' | 'PLAYER_LEFT' | 'PLAYER_READY' | 'KICK_PLAYER' | 'ROOM_STATE' | 'CHAT_MESSAGE' | 'GAME_START' | 'GAME_COUNTDOWN' | 'WORD_GEN' | 'INPUT_REPORT' | 'INPUT_RESULT' | 'SCORE_UPDATE' | 'RANK_UPDATE' | 'GAME_END' | 'ERROR' | 'PONG';
